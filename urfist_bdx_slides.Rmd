...
.pull-right[
Ouverture des données de la recherche. Guide d'analyse du cadre juridique en France. 2017. 
...
* Fonctionnent-ils en ligne ou après installation sur un ordinateur ? * Fonctionnent-ils avec un système d’exploitation particulier (Windows, Mac, Linux) ? 
...
* Conserver plusieurs copies de ses données sur différents lieux de stockage. * Règle de la **sauvegarde 3-2-1 : 3 copies sur 2 supports différents, avec au moins 1 une copie à distance**
...
https://github.com/carenes/urfist_bdx_DMP/blob/master/materiel/DMP_BDD_Nice.pdf
...
<small>Source : CNIL. CC-BY-ND 3.0 FR. https://www.cnil.fr/fr/les-bases-legales/liceite-essentiel-sur-les-bases-legales</small>
...
<small>Source : CNIL. CC-BY-ND 3.0 FR. https://www.cnil.fr/fr/cnil-direct/question/quels-sont-les-grands-principes-des-regles-de-protection-des-donnees</small>
...
<small>Source : Doranum. CC:BY. https://doranum.fr/aspects-juridiques-ethiques/protection-des-donnees-personnelles-et-rgpd-dans-la-recherche-consequences-obligations-implications/</small>
...
https://doranum.fr/wp-content/uploads/FS_Checklist.pdf 
...
Si vous n'avez pas de fichier test, utilisez le fichier suivant : https://github.com/carenes/urfist_bdx_DMP/blob/master/materiel/rongeurs.xlsx
...
Un guide : Association des Archivistes de France. « **Référentiel de gestion des archives de la recherche** ». https://www.archivistes.org/IMG/pdf/referentiel_recherche_intro_septembre2012_corrige_.pdf 
...
* Documenter ses pratiques sans attendre le 1er livrable 6 mois après le démarrage du projet
...
Retrouvez et réutilisez cette présentation sur Zenodo (à venir).
