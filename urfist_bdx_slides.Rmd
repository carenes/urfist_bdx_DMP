...
[Support et matériel](àajouter) à télécharger
...
.center[
```{r echo=FALSE, out.height=296, out.width=330}
knitr::include_graphics("img/aware.png")
```
]

<small>[Source image](https://commons.wikimedia.org/wiki/File:Van_Damme_Cannes.jpg)</small>
...
* Une plus grande **efficacité** (et un meilleur gestion des coûts de gestion)
...
# Le modèle de l'ANR - un exemple

LipInTB / Jean-François Cavalier. 2021. https://dmp.opidor.fr/plans/4624/export.pdf

&nbsp;

**Exercice** : lisez ce PGD au regard des questions du modèle de l'ANR, qu'en pensez vous ?
...
*Sur le site DMP OPIDoR, choisissez trois [modèles](https://dmp.opidor.fr/public_templates) de PGD et observez leurs différences. Lesquels vous paraissent aisés à utiliser, pourquoi ? Certains vous semblent-ils particulièrement complexes, pourquoi ?*
...
Ces informations figureront dans le PGD, mais il peut être utile de les documenter en amont pour avoir de bonnes pratiques de gestion. 

---

# Documenter ses données : un guide

Un guide : Arnould, Pierre-Yves, et Marie-Christine Jacquemot-Perbal. 2017. 
...
Plus modestement, cette formation : projet déposé sur Zenodo avec le support, le matériel et la documentation pour qu'elle puisse réutilisable. 
...
* Un standard générique, le dublin core : 15 champs
  * parfois associé à des standards disciplinaires : DDI (SHS), EML (écologie), DwC (Darwin Core, biodiversité)
...
* Trames de fichiers Readme :
  ...
  * Doranum. Gabarit « Readme ».
  * https://doranum.fr/wp-content/uploads/gabarit_readme.txt 
...
# Où et comment partager ses données ?
...
* Les données peuvent-elles être utilisées à des fins d'enseignements ?
...
* Le **responsable du DMP** : pas forcément la responsable du projet.
...
Commencez à rédiger votre trame de PGD. Des exemples fictifs de projets sont à votre disposition. 
...
* Borgman, Christine L. 2020. Qu’est-ce que le travail scientifique des données ? : Big data, little data, no data. Traduit par Charlotte Matoussowsky. Qu’est-ce que le travail scientifique des données ? : Big data, little data, no data. Encyclopédie numérique. Marseille: OpenEdition Press. http://books.openedition.org/oep/14692.
...
Retrouvez et réutilisez cette présentation sur 
[zenodo](à ajouter).
